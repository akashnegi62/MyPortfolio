...
import Replit from "../assets/Image/Replit.svg";
import Resume from "../assets/Resume/AkashResume.pdf";
function Contact() {
  ...
  const [data, setdata] = useState([
    {
      name: "Linkdin",
      img: Linkedin,
      link: "https://www.linkedin.com/in/akashnegi7142/",
    },
    {
      name: "Github",
      img: Github,
      link: "https://github.com/akashnegi7142",
    },
    {
      name: "Instagram",
      img: Instagram,
      link: "https://instagram.com/akashnegi7142",
    },
    {
      name: "Replit",
      img: Replit,
      link: "https://replit.com/@akashnegi7142",
    },
  ]);
  setdata;
  // animation
  ...
  const openLink = () => {
    ...
    window.open("https://akashnegi62.github.io/Portfolio/", "_blank");
  };

  return (
    <div
      id="Contact"
      className="h-[150vh] lg:h-[120vh] w-full bg-[#243a38] pt-[30vw] lg:py-[10vw] px-[5vw] relative overflow-hidden"
    >
      <h1 className="text-[20vw] font-[gilsem] leading-none text-center text-white lg:hidden">
        Let's <br /> Co<span className="text-[#14cf92] font-[gilit]">nn</span>
        ect
      </h1>
      <h1
        ref={textRef}
      ...
      <div className="min-h-[20vh] lg:h-[15vh] w-full flex flex-col lg:flex-row gap-[5vw] lg:gap-0 items-center mt-[10vw] lg:mt-[5vw] px-[2vw] lg:px-0 text-white">
        <button
          ...
          className="relative overflow-hidden w-full bg-white lg:bg-[#fff0] text-black lg:text-white lg:w-[50%] border-1 border-white py-[5vw] lg:py-[2.5vw] mr-[2vw] rounded-full text-xl lg:text-[1.5vw] font-[gilroy] hover:text-black z-[12]  before:absolute before:h-[12.6vh] before:w-[100%] before:bg-white before:top-[100%] before:left-0 before:z-[-1] hover:before:top-[0%] before:transition-all before:duration-300 before:ease-in-out"
        >
          Write A Message
        </button>
        <button
        ...
        <div className="min-h-[30vh] w-full flex flex-col justify-center gap-[4vw] text-white lg:hidden relative">
          {data.map((items, index) => (
            <a key={index} href={items.link} target="_blank">
              <div className="shaders h-[10vh] w-full px-[8vw] flex justify-between items-center border-t-1 border-white">
                <div className="app_text font-[gilroy] absolute left-0">
                  <h1 className="text-2xl ">{items.name}</h1>
                  <p className="text-sm  text-[#a6b0ae]">@akashnegi7142</p>
                </div>
      ...
      <div className="hidden lg:block">
        <div className="h-[15vh] w-full flex justify-center gap-[4vw] absolute left-0 bottom-[20vh] z-10 text-white">
          {data.map((items, index) => (
            <a key={index} href={items.link} target="_blank">
              <div className="shaders h-[8vh] w-[20vw] py-0 flex justify-between items-center border-t-1 border-white hover:px-2 hover:text-[#14cf92] hover:transition-all hover:duration-300 hover:ease-in-out">
